...
function EditPizza({ pizza, pizzaID }) {
    ...
    return (
        <form>
            ...
            <button button style={{ margin: "10px 0" }} className="primary_btn" type="submit" > Update Pizza</button >
        </form>
    )
}
...
//     const response = await fetch(`https://next-js-restaurant-pto3ljysn-yazan-ali.vercel.app/api/pizza/${pizzaID}`);
